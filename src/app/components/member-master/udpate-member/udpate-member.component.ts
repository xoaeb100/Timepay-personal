...
@Component({
  selector: 'app-udpate-member',
  templateUrl: './udpate-member.component.html',
  styleUrls: ['./udpate-member.component.scss']
})
export class UdpateMemberComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.title.setTitle("Update Member Details @ Timepay 2.0")
